...
async def receive_style(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton(
            ...
            url=f"https://t.me/share/url?text=Let%27s%20make%20a%20comic%20together%21%20Join%20my%20Plotshot%20game%20%E2%80%94%20takes%202%20minutes%2C%20guaranteed%20to%20be%20ridiculous%20%F0%9F%91%87&url={deep_link}",
        )],
        [InlineKeyboardButton(
